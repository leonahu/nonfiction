...
(function (window) {
    ...
    Util = {
        ...
        insertHTMLCommand: function (doc, html) {
            ...
            var replacements = [
              [new RegExp(/<!--StartFragment-->(.*)<!--EndFragment-->/g), '$1'],
              [new RegExp(/^[\s\n\r]*|[\s\n\r]*$/g), '']
            ];
    ...
    */
    function createReplacements() {
        return [
            ...
            // Divs
            ,[new RegExp(/<div[^>]*>/gi), '']
            ,[new RegExp(/<\/div>/gi), '<<<br>']
            ,[new RegExp(/(<br>)*(<<<br>)*<<<br>(<<<br>)*(<br>)*/gi), '<br>']
    ...
    PasteHandler.prototype = {
        handlePaste: function (event, element) {
            ...
            if (event.clipboardData &&
                ...
                if (this.options.cleanPastedHTML && event.clipboardData.getData(dataFormatHTML)) {   
                    cleaned = this.cleanPaste(event.clipboardData.getData(dataFormatHTML));
                    return cleaned;
                }
        ...
        cleanPaste: function (text) {
            ...
            for (i = 0; i < replacements.length; i += 1) {
                ...
                //console.log(replacements[i][0], text);
            }
