...
require __DIR__ . DS . 'vendor' . DS . 'html-to-markdown.php';
...
class MediumField extends BaseField {
    ...
    const COMMENT_REMOVAL_REGEX = '/<!--(.*)-->/Uis';
    ...
    public static $assets = array(
      'js' => array(
        'medium-editor.js',
        'medium-editor-button.js',
        'autosize.min.js',
        'medium.js'
      ),
      'css' => array(
        'medium-editor.css',
        'medium-theme-default.css'
      ),
    );
    ...
    public function __construct() {
      ...
      $this->firstHeader = c::get('field.medium.first-header', 'h2');
      ...
      $this->secondHeader = c::get('field.medium.second-header', 'h3');
    ...
    public function result() {
        ...
        // (2) Strip <span> elements and comments
        $result = preg_replace(self::SPAN_REMOVAL_REGEX, '', $result);
        $result = preg_replace(self::COMMENT_REMOVAL_REGEX, '', $result);
        //echo $result;
