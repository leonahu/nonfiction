...
<nav class="nav1" role="navigation">
  <div class="box">
    <div class="navbg"></div>
    <ul>
      <li><a href='/about' class='link <?php if ($o->class == 'about') echo "active" ?>'>About<?php echo b::x() ?></a></li><!--
...
<nav class="nav2" role="navigation">
  <div class="box">
    <div class="navbg"></div>
    <ul>
      <li><a href='/clients' class='link <?php if ($o->class == 'clients') echo "active" ?>'>Clients<?php echo b::x() ?></a></li><!--
    --><li><a href='/projects' class='link <?php if (preg_match("/project/", $o->class)) echo "active" ?>'>Work<?php echo b::x() ?></a></li><!--
    --><li><a href='/faq' class='link leftx <?php if ($o->class == 'faq') echo "active" ?>'><?php echo b::x() ?>FAQ</a></li>
    </ul>
  </div>
</nav>
